...
IMPLEMENTATIONS: dict[str, str] = {
    "NUMBER": "test_the_quoted_line_count_of_the_adapter_example_is_the_real_one",
    "COMMAND": "test_every_quickstart_command_runs_and_exits_zero",
    "OUTPUT": "test_the_hero_table_is_captured_output_from_the_bundled_demo",
    "REFERENCE": "test_the_readme_frame_is_built_from_the_captured_output",
}
...
def _resolves(claim: str) -> bool:
    ...
    `quellz/thing.py` because that is the import path a reader types, and the file is at
    `src/quellz/thing.py`. Both are correct and a check that refused the first would be wrong.
    """
