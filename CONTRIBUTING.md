...
```bash
git clone https://github.com/PNX89/QUELLZ.git && cd QUELLZ
...
- with the adapter extra
- zero dependency core alone
...
https://pnx89.github.io/QUELLZ, come from a real run whose output is committed under
